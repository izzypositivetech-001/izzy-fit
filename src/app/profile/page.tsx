...
const ProfilePage = () => {
  ...
  if (authLoading || !clerkLoaded) {
    return <div className="text-center pt-12">Loading profile...</div>;
  }

  if (!isAuthenticated || !user) {
    return <div className="text-center pt-12">Please sign in to view plans</div>;
  }

  // Add loading state for query
  if (allPlans === undefined) {
    return <div className="text-center pt-12">Loading plans...</div>;
  }
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="font-mono text-sm text-muted-foreground">
                          SCHEDULE: {currentPlan.workoutPlan.schedule?.join(", ") || "Not specified"}
                        </span>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="font-mono text-xl text-primary">
                          {currentPlan.dietPlan.dailyCalories || 0} KCAL
                        </div>
                      </div>
                        ...
                        {currentPlan.dietPlan.meals?.map((meal, index) => (
                          ...
                          >
                            ...
                            <ul className="space-y-2">
                              ...
                              )) || <li className="text-muted-foreground">No foods listed</li>}
                            </ul>
                          </div>
