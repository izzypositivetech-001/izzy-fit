...
import { DumbbellIcon, HomeIcon, User, UserIcon, ZapIcon } from "lucide-react";
...
const Navbar = () => {
  ...
  return (
    <div>
       <header className="fixed top-0 left-0 right-0 z-50 bg-background/60 backdrop-blur-md border-border py-3">
           <div className="container mx-auto flex items-center justify-between">
            ...
            <nav className="flex items-center gap-5">
                ...
                >
                    <Link href= "/generate-program">Get Started
                    </Link>
                </Button>
                <UserButton  />
                    </>
